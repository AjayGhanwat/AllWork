...
public class GetToJSONSociety {
    ...
    public static void getList(double currentLatitude, double currentLongitude) {
        ...
        for (int i = 1000; i < 4000; i = i + 500) {
            ...
            String url = "https://maps.googleapis.com/maps/api/place/nearbysearch/json?location="+currentLatitude+","+currentLongitude+"&radius=1000&keyword=Society&sensor=true&key=AIzaSyABpsXU1PTjgxdWsboX8JzRwX-3sKPRRbY";
                    ...
                    new Response.Listener<JSONObject>() {
                        ...
                        public void onResponse(JSONObject response) {
                            ...
                            try {
                                ...
                                MainActivity.spinnerSociety.setAdapter(aa);
